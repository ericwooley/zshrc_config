...
- [Install](INSTALL.md): one-line bootstrap, local install flow, Homebrew and dependency setup, optional zsh update cron, backups, TigerVNC setup, Neovim tarball updates, and uninstall notes
