...
- [Install](INSTALL.md): one-line bootstrap, local install flow, backups, dependency setup, and uninstall notes
- [Zsh](ZSH.md): shell load order, plugins, completions, functions, and local overrides
