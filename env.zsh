...
# fastAI.
export FASTAI_DEFAULT_PROVIDER="${FASTAI_DEFAULT_PROVIDER:-openrouter}"
export FASTAI_DEFAULT_MODEL="${FASTAI_DEFAULT_MODEL:-deepseek/deepseek-v4-flash}"
export FASTAI_DEFAULT_PERMISSIONS="${FASTAI_DEFAULT_PERMISSIONS:-read}"
